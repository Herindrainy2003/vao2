...
<input type="submit" name="publish" id="publish" class="button button-primary button-large yith-wcbm-save-badge-button yith-plugin-fw__button--xxl" value="<?php esc_html_e( 'Save badge', 'yith-woocommerce-badges-management' ); ?>">
