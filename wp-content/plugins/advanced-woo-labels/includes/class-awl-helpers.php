                    ...
                    foreach ( $hooks_list_type as $hooks_display => $hooks_list ) {
                        ...
                        foreach ( $hooks_list as $hook_name => $hook_vars ) {
                            if ( isset( $hook_vars['js'] ) && is_array( $hook_vars['js'] ) ) {
                                $label_selector = isset( $hook_vars['label_js_selector'] ) && is_string( $hook_vars['label_js_selector'] ) ? $hook_vars['label_js_selector'] : '.awl-label-type-' . $hooks_display . '.awl-position-type-' . sanitize_title( str_replace( '_', '-', $position ) );
