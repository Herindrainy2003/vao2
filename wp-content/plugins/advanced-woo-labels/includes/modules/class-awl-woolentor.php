    ...
    class AWL_Woolentor {
        ...
        public function wp_get_attachment_image( $html ) {
            ...
            foreach ( debug_backtrace() as $trace_part ) {
                if ( isset( $trace_part['class'] ) && ( strpos( $trace_part['class'], 'Woolentor_Universal_Product' ) || strpos( $trace_part['class'], 'Woolentor_Product_Accordion' ) || strpos( $trace_part['class'], 'Woolentor_Wl_Custom_Archive_Layout_Widget' ) ) ) {
